...
sender_address = '0x......'
spend = web3.to_checksum_address("0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c")
...
wom_contract_id = web3.to_checksum_address("Contract Token Address")
usdt_contract_id = web3.to_checksum_address("0x55d398326f99059fF775485246999027B3197955")
...
sellTokenContract = web3.eth.contract(wom_contract_id, abi=sellAbi)
...
time.sleep(10)
print(f"Swapping {tokenValue2} {symbol} for USDT")

pancakeswap2_txn = contract.functions.swapExactTokensForTokens(
    tokenValue, 0,
    [wom_contract_id, usdt_contract_id],
    sender_address,
...
print(Style.GREEN + f"Sold {symbol} for USDT:" + Style.RESET, "https://bscscan.com/tx/" + web3.to_hex(tx_token))
